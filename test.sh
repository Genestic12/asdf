...
CHECKPOINT_MODELS=(
    ...
    "https://civitai.red/api/download/models/2792241?type=Model&format=SafeTensor&size=pruned&fp=fp16" #Nova F17
    #"https://civitai.com/api/download/models/2598129?type=Model&format=SafeTensor&size=pruned&fp=fp16" #Nova PKM
